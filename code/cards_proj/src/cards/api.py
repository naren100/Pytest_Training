...
@dataclass  # In Python, a dataclass is a simpler way to create classes that are mainly used to store data (like a task card or a record).
class Card:
    summary: str = None
    owner: str = None
    state: str = "todo"
    ...
    @classmethod # @classmethod is a decorator that lets you define a method that is bound to the class,
    # not the instance. Instead of using self it uses cls (Class)
    def from_dict(cls, d):
        return Card(**d)
    def to_dict(self):
        return asdict(self)
